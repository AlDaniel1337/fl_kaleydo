...
/// Definición de los colores utilizados en la aplicación.
class AppColors {
  static const Color background = Color(0xFF0F0E17);
  static const Color sidebarBackground = Color(0xFF13121C);
  static const Color cardBackground = Color(0xFF191726);
  ...
  static const Color searchBackground = Color(0xFF1B1A2A);
}